...
public class FlameDamage : DamageClass
{
	public override void SetStaticDefaults()
    {
		ClassName.SetDefault("burning damage");
	}
	...
	public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
	{
		...
		if (damageClass == DamageClass.Melee)
			return new StatInheritanceData(
				damageInheritance: 0.12f,
				critChanceInheritance: 0.12f,
				attackSpeedInheritance: 0.16f,
	...
	public override void SetDefaultStats(Player player)
	{
		...
		player.GetCritChance<FlameDamage>() += 2;
		player.GetArmorPenetration<FlameDamage>() += 5;
