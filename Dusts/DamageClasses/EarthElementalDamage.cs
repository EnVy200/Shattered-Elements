...
public class EarthDamage : DamageClass
{
	public override void SetStaticDefaults()
    {
		ClassName.SetDefault("turfic damage");
	}
	...
	public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
	{
		...
		if (damageClass == DamageClass.Magic)
			return new StatInheritanceData(
				...
				armorPenInheritance: 1.03f,
				knockbackInheritance: 0.14f
			);
		...
		if (damageClass == DamageClass.Ranged)
			return new StatInheritanceData(
				damageInheritance: 0.08f,
				critChanceInheritance: 0.08f,
				attackSpeedInheritance: 0.11f,
				armorPenInheritance: 1.01f,
	...
	public override void SetDefaultStats(Player player)
	{
		...
		player.GetCritChance<EarthDamage>() += 2;
		player.GetArmorPenetration<EarthDamage>() += 5;
