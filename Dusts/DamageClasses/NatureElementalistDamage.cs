...
public class NatureDamage : DamageClass
{
	public override void SetStaticDefaults()
    {
		ClassName.SetDefault("rooted damage");
	}
	...
	public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
	{
		...
		if (damageClass == DamageClass.Melee)
			return new StatInheritanceData(
				damageInheritance: 0.07f,
				critChanceInheritance: 0.07f,
				attackSpeedInheritance: 0.09f,
				armorPenInheritance: 0.91f,
				knockbackInheritance: 0.11f
			);
		if (damageClass == DamageClass.Magic)
			return new StatInheritanceData(
				damageInheritance: 0.11f,
				critChanceInheritance: 0.11f,
				attackSpeedInheritance: 0.13f,
				armorPenInheritance: 1.04f,
				knockbackInheritance: 0.15f
			);
		if (damageClass == DamageClass.Summon)
			return new StatInheritanceData(
				damageInheritance: 0.09f,
				critChanceInheritance: 0.09f,
				attackSpeedInheritance: 0.12f,
				armorPenInheritance: 1.02f,
				knockbackInheritance: 0.12f
			);
	...
	public override void SetDefaultStats(Player player)
	{
		...
		player.GetCritChance<NatureDamage>() += 2;
		player.GetArmorPenetration<NatureDamage>() += 5;
