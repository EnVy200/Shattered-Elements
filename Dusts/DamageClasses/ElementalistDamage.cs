...
public class ElementalistDamage : DamageClass
{
	public override void SetStaticDefaults()
    {
		ClassName.SetDefault("elemental damage");
	}
	...
	public override void SetDefaultStats(Player player)
	{
		...
		player.GetCritChance<ElementalistDamage>() += 2;
		player.GetArmorPenetration<ElementalistDamage>() += 5;
