...
namespace TrueSoul.DamageClasses;

public class ElectricDamage : DamageClass
{
	public override void SetStaticDefaults()
    {
		ClassName.SetDefault("shocking damage");
	}
	...
	public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
	{
		...
		if (damageClass == DamageClass.Melee)
			return new StatInheritanceData(
				damageInheritance: 0.04f,
				critChanceInheritance: 0.04f,
				attackSpeedInheritance: 0.06f,
				armorPenInheritance: 0.86f,
				knockbackInheritance: 0.06f
			);
		if (damageClass == DamageClass.Magic)
			return new StatInheritanceData(
				damageInheritance: 0.06f,
				critChanceInheritance: 0.06f,
				attackSpeedInheritance: 0.08f,
				armorPenInheritance: 0.99f,
				knockbackInheritance: 0.10f
			);
		if (damageClass == DamageClass.Summon)
			return new StatInheritanceData(
				damageInheritance: 0.03f,
				critChanceInheritance: 0.03f,
				attackSpeedInheritance: 0.06f,
				armorPenInheritance: 0.96f,
				knockbackInheritance: 0.06f
			);
		if (damageClass == DamageClass.Ranged)
			return new StatInheritanceData(
				damageInheritance: 0.04f,
				critChanceInheritance: 0.04f,
				attackSpeedInheritance: 0.07f,
				armorPenInheritance: 0.97f,
				knockbackInheritance: 0.07f
			);
		return new StatInheritanceData(
	...
	public override void SetDefaultStats(Player player)
	{
		...
		player.GetCritChance<ElectricDamage>() += 2;
		player.GetArmorPenetration<ElectricDamage>() += 5;
