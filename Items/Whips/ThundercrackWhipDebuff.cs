...
{
	public class ThundercrackWhipDebuff : ModBuff
	{
		...
		{
			npc.GetGlobalNPC<ThundercrackWhipDebuffNPC>().markedByWhip = true;
		}
	}

	public class ThundercrackWhipDebuffNPC : GlobalNPC
	{
