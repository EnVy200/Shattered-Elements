...
{
	public class GelatinWhipProjectile : ModProjectile
	{
		...
		{
			target.AddBuff(ModContent.BuffType<GelatinWhipDebuff>(), 240);
			target.AddBuff(ModContent.BuffType<StickyDebuff>(), 250);
