...
{
    internal class OnyxShard : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.SetDefault("Purified Onyx");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<OnyxShardTile>();
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<OnyxShardBlack>());
