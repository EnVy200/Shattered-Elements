...
namespace TrueSoul.Items.Elementalist
{
        ...
        public class WindsweptSaw : ModItem
        {
            public override void SetStaticDefaults()
            {
                DisplayName.SetDefault("Windswept Sawblade");
                Tooltip.SetDefault("Fires a wind sawblade that has high knockback.");
            ...
            public override void SetDefaults()
            {
                ...
                Item.value = 9060;
                Item.DamageType = ModContent.GetInstance<AirDamage>();
                Item.autoReuse = true;
                Item.shoot = ModContent.ProjectileType<WindsweptSawblade>();
                Item.shootSpeed = 13;
